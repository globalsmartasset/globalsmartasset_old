/* src/config/globalsmartasset-config.h.  Generated from globalsmartasset-config.h.in by configure.  */
/* src/config/globalsmartasset-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef globalsmartasset_CONFIG_H

#define globalsmartasset_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.globalsmartasset.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "globalsmartasset Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "globalsmartasset Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "globalsmartasset"
...
#endif //globalsmartasset_CONFIG_H
