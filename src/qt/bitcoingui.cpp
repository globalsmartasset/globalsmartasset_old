                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("globalsmartasset Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a globalsmartasset address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and globalsmartasset: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zsnd"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About globalsmartasset Core"), this);
    aboutAction->setStatusTip(tr("Show information about globalsmartasset Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for globalsmartasset"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your globalsmartasset addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified globalsmartasset addresses"));
    ...
    openAction->setStatusTip(tr("Open a globalsmartasset: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the globalsmartasset Core help message to get a list with possible globalsmartasset command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("globalsmartasset Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to globalsmartasset network", "", count));
}
...
{
    QString strTitle = tr("globalsmartasset Core"); // default title
    ...
    // Append title to "globalsmartasset - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
...
/** Creates context menu, its actions, and globalsmartassets up all the relevant signals for mouse events. */
