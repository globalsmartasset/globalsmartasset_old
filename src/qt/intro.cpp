...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("globalsmartasset Core"),
     ...
     * override -datadir in the globalsmartasset.conf file in the default data directory
     * (to be consistent with globalsmartassetd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
