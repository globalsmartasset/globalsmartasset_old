...
public:
    ...
    void setZglobalsmartassetControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzsnd_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzsnd_clicked();
    void on_pushButtonZglobalsmartassetControl_clicked();
