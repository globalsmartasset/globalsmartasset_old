...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(globalsmartasset);
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case globalsmartasset:
            return QString("tgsa");
        case msnd:
            return QString("mtgsa");
        case usnd:
            return QString::fromUtf8("μtgsa");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case globalsmartasset:
            return QString("globalsmartasset");
        case msnd:
            return QString("Milli-globalsmartasset (1 / 1" THIN_SP_UTF8 "000)");
        case usnd:
            return QString("Micro-globalsmartasset (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
