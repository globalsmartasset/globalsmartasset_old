...
/** Utility functions used by the globalsmartasset Qt UI.
 */
namespace GUIUtil
{
...
// Render globalsmartasset addresses in monospace font
...
// Parse "globalsmartasset:" URI into recipient object, return true on successful parsing
