...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted globalsmartasset to zsnd");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zsnd");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received globalsmartasset from zsnd");
    case TransactionRecord::ZerocoinSpend_Change_zsnd:
        return tr("Minted Change as zsnd from zsnd Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zsnd to globalsmartasset");
