...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("globalsmartasset Core globalsmartasset-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  globalsmartasset-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded globalsmartasset transaction") + "\n" +
                               "  globalsmartasset-tx [options] -create [commands]   " + _("Create hex-encoded globalsmartasset transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded globalsmartasset transaction
