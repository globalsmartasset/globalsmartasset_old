...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop globalsmartasset server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "globalsmartasset server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* globalsmartasset features */
        {"globalsmartasset", "masternode", &masternode, true, true, false},
        {"globalsmartasset", "listmasternodes", &listmasternodes, true, true, false},
        {"globalsmartasset", "getmasternodecount", &getmasternodecount, true, true, false},
        {"globalsmartasset", "masternodeconnect", &masternodeconnect, true, true, false},
        {"globalsmartasset", "masternodecurrent", &masternodecurrent, true, true, false},
        {"globalsmartasset", "masternodedebug", &masternodedebug, true, true, false},
        {"globalsmartasset", "startmasternode", &startmasternode, true, true, false},
        {"globalsmartasset", "createmasternodekey", &createmasternodekey, true, true, false},
        {"globalsmartasset", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"globalsmartasset", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"globalsmartasset", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"globalsmartasset", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"globalsmartasset", "getmasternodescores", &getmasternodescores, true, true, false},
        {"globalsmartasset", "mnbudget", &mnbudget, true, true, false},
        {"globalsmartasset", "preparebudget", &preparebudget, true, true, false},
        {"globalsmartasset", "submitbudget", &submitbudget, true, true, false},
        {"globalsmartasset", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"globalsmartasset", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"globalsmartasset", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"globalsmartasset", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"globalsmartasset", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"globalsmartasset", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"globalsmartasset", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"globalsmartasset", "checkbudgets", &checkbudgets, true, true, false},
        {"globalsmartasset", "mnsync", &mnsync, true, true, false},
        {"globalsmartasset", "spork", &spork, true, true, false},
        {"globalsmartasset", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"globalsmartasset", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use globalsmartassetd, or the -server option to globalsmartasset-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> globalsmartasset-cli " + methodname + " " + args + "\n";
}
