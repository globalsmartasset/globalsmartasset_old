...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("globalsmartasset Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  globalsmartasset-cli [options] <command> [params]  " + _("Send command to globalsmartasset Core") + "\n" +
                        "  globalsmartasset-cli [options] help                " + _("List commands") + "\n" +
                        "  globalsmartasset-cli [options] help <command>      " + _("Get help for a command") + "\n";
