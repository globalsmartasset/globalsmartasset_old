...
In order to support loading of multiple wallets in globalsmartasset-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is globalsmartasset.cpp.
...
Changes to globalsmartasset.cpp
----------------------
globalsmartasset.cpp is the entry point into globalsmartasset-qt, and as such, will require some minor modifications to provide hooks for
