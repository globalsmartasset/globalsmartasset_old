Contributing to globalsmartasset Core
============================

The globalsmartasset Core project operates an open contributor model where anyone is
...
The following applies to code changes to the globalsmartasset Core project, and is not to be
confused with overall globalsmartasset Network Protocol consensus changes.

Whether a pull request is merged into globalsmartasset Core rests with the project merge
...
Patches that change globalsmartasset consensus rules are considerably more involved than
...
Where a patch set proposes to change the globalsmartasset consensus, it must have been
...
The project leader is the release manager for each globalsmartasset Core release.
